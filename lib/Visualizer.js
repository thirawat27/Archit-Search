...
/**
 * Decoration style configuration for different severity levels
 */
 ...
 * Applies text decorations and diagnostics for visual feedback.
 */
class Visualizer {
    /**
     ...
     * 
     * @param {typeof DECORATION_STYLES.error} style - Style configuration
    ...
    report(editor, violations) {
        ...
        for (const violation of violations) {
            ...
            // Create decoration
            const decoration = this._createDecoration(violation.range, violation.message, style.icon);
     ...
     * @private
     */
    _createDecoration(range, message, icon) {
        return {
            range: range,
            hoverMessage: message,
            renderOptions: {
                after: {
                    contentText: ` ${icon} ${message}`
                }
            }
        };
    }
